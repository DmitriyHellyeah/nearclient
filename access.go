...
func (c *Client) ViewAccessKey(ctx context.Context, accountId, publicKey string) (resp types.ViewAccessKey, err error) {
...
func (c *Client) ViewAccessKeyChangesAll(ctx context.Context, accountIds []string, blockId uint64) (resp types.ViewAccessKey, err error) {
